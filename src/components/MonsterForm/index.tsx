...
import useMonsterForm from "@/components/MonsterForm/hooks/useMonsterForm";
import BackToMonsters from "../BackToMonsters";
    ...
    <div className="container mx-auto max-w-2xl px-4">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        >
          ...
          <span>{isSubmitting ? "Creating Monster..." : "Create Monster"}</span>
        </button>
      </form>
    </div>
  );
